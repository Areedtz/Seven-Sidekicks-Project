...
def process_data_and_extract_profiles(song_id: str, song_file: str, song_output_file: str) -> Tuple[str, Tuple, Tuple, Tuple, Tuple, Tuple, Tuple]:
    """Gets lowlevel datafile and uses this to find define moods and returns a tuple with them
