...
def process_data_and_extract_emotions(
        video_id: str, video_path: str, time_range: Dict[str, int]) -> bool:
...
def process_data_and_extract_emotions_with_song(
        video_id: str, video_path: str,
        time_range: Dict[str, int], song_id: str) -> bool:
